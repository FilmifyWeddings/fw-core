...
const sql = fs.readFileSync(path.join(__dirname, '../supabase/migrations/20260618000001_admin_telemetry_ota.sql'), 'utf-8');

async function main() {
  console.log('Attempting to run telemetry and OTA version SQL migration via RPC...');
  // Try 'exec_sql'
