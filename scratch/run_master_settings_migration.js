...
const sql = fs.readFileSync(path.join(__dirname, '../supabase/migrations/20260619000003_master_settings.sql'), 'utf-8');

async function main() {
  console.log('Attempting to run Master Settings SQL migration via RPC...');
  // Try 'exec_sql'
