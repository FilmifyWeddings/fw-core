...
const sql = fs.readFileSync(path.join(__dirname, '../supabase/migrations/20260612000001_templates.sql'), 'utf-8');

async function main() {
  console.log('Attempting to run migration SQL via RPC...');
  // Try 'exec_sql'
