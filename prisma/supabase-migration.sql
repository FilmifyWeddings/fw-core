-- ============================================================================
-- StudioCore Enterprise SaaS Architecture Migration
...
CREATE TABLE IF NOT EXISTS public.quotation_assets (
  id TEXT PRIMARY KEY DEFAULT gen_random_uuid()::text,
  template_id TEXT NOT NULL REFERENCES public.quotation_templates(id) ON DELETE CASCADE,
  user_id UUID NOT NULL,
  url TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_versions_version ON public.quotation_versions(version);
