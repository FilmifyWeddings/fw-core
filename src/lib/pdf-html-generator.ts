...
export function getEmbeddedCustomFontsBase64CSS(): string {
  ...
  try {
    ...
    console.warn('[PDF Font Embed Warning]:', e);
  }
  return css;
}

/**
 * Enterprise Single Source of Truth HTML Generator for PDF Export.
 * Renders the exact same React component canvas (<QuotationDocumentCanvas />) to static markup.
 */
export function renderQuotationToHTML(documentData: any): string {
  ...
  // Render shared React Canvas Component to Static HTML String
