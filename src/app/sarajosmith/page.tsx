...
function PublicContent() {
  ...
  const handleOpenPackageInquiry = (pkg: PricingPackage) => {
    setSelectedPackage(pkg);
    setIsInquiryOpen(true);
  };

  return (
    <div className="min-h-screen w-full sjs-container font-sjs-body text-[#292421] selection:bg-[#C6B495]/40 selection:text-[#292421]">
      ...
      <main className="w-full">
        ...
        <CollectionsSection onSelectPackage={handleOpenPackageInquiry} />
...
export default function SaraJoSmithPublicPage() {
  return (
    <SaraJoSmithProvider isAdmin={false}>
      <PublicContent />
    </SaraJoSmithProvider>
  );
}
