...
export default function LeadsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] dark:bg-[#121110] text-[#1A1A1A] dark:text-[#F5F5F5] transition-colors duration-250 font-sans">
      <main className="w-full max-w-[100vw] px-4 md:px-8 py-8 space-y-6">
        
        {/* Header */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-extrabold tracking-tight text-[#1A1A1A] dark:text-[#F5F5F5]">Lead Flow Database</h1>
            <p className="text-xs text-[#706E6A] dark:text-[#A09E9A] mt-1">Manage deal statuses, scoring reasons, and metadata</p>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="p-2 bg-[#FFFFFF] dark:bg-[#1C1A18] hover:bg-[#FAF8F5] dark:hover:bg-[#121110] border border-[#E8E5DF] dark:border-[#2C2926] hover:border-[#D4AF37] dark:hover:border-[#C5A059] text-[#706E6A] dark:text-[#A09E9A] hover:text-[#1A1A1A] dark:hover:text-white rounded-xl transition-all flex items-center justify-center shadow-sm"
