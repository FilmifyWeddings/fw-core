...
export default function LeadsPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-[#070708] text-zinc-900 dark:text-white selection:bg-zinc-200 dark:selection:bg-zinc-850 transition-colors duration-200">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">Manage deal statuses, scoring reasons, and metadata</p>
          </div>
